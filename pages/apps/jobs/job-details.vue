                        ...
                        <div class="d-flex flex-wrap align-items-top justify-content-between gap-2">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <div>
                                        <span class="avatar avatar-rounded avatar-lg">
                                            <img src="/images/company-logos/8.png" alt="">
                                        </span>
                                    </div>
                                    <div>
                                        <h4 class="fw-bold mb-0 d-flex align-items-center"><a href="javascript:void(0);">UI
                                                Developer - Fresher</a></h4>
                                        <a href="javascript:void(0);" class="fw-semibold"><i class="bi bi-building"></i>
                                            Spruko Technologies .PVT.LTD</a>
                                        <div class="d-flex fs-14 mt-3">
                                            ...
                                            <div class="ms-4">
                                                <p class="mb-1"><i class="bi bi-coin me-1"></i><b>10,000 - 20,000</b> / per
                                                    month (+incentives)</p>
                                        ...
                                        <div class="popular-tags">
                                            <a href="javascript:void(0);"
                                                class="badge rounded-pill bg-info-transparent me-2"><i
                                                    class="bi bi-clock me-1"></i>Full Time</a>
                                            <a href="javascript:void(0);"
                                                class="badge rounded-pill bg-danger-transparent"><i
                                                    class="bi bi-briefcase me-1"></i>13 Openings</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="btn-list mb-2">
                                    <a href="javascript:void(0);" class="btn btn-primary"><i class="fa fa-check me-1"></i>
                                        Apply Now</a>
                                ...
                                <p class="mb-0"><i class="bi bi-info-circle text-danger"><v-tooltip activator="parent"
                                            location="top">45 days left</v-tooltip></i> <b>45 days left </b> to apply this
                                    job</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="card-body">
                            ...
                            <p class="op-9">Est amet sit vero sanctus labore no sed ipsum ipsum nonumy. Sit ipsum sanctus ea
                                magna est. Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum erat et kasd.Est amet sit vero
                                sanctus labore no sed ipsum ipsum nonumy vero sanctus labore.A officiis optio temporibus
                                minima facilis...</p>
                            <p class="mb-4 op-9">Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit
                                ipsum ipsum erat et kasd.Est amet sit vero sanctus labore no sed ipsum ipsum nonumy vero
                                sanctus labore..</p>
                            <h5 class="fw-semibold">Key Responsibilities</h5>
                            <ol class="list-group border-0 list-unstyled list-group-numbered mb-3">
                                <li class="list-group-item border-0 py-1">Design thoughtful, beautiful, and useful software
                                    user interfaces and experiences in a team environment..</li>
                                <li class="list-group-item border-0 py-1">Create user-centered designs by considering market
                                    analysis, customer feedback, site metrics, and usability findings.</li>
                                <li class="list-group-item border-0 py-1">Work with stakeholders to plan projects for
                                    effective delivery while maintaining high standards for design..</li>
                                <li class="list-group-item border-0 py-1">Be a passionate and effective advocate for design
                                    with non-design audiences..</li>
                                <li class="list-group-item border-0 py-1">Use business requirements, user and market
                                    research to assist in developing scenarios, use cases, and high-level requirements..
                                </li>
                            </ol>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 text-end">
                                <a href="javascript:void(0);" class="btn btn-success btn-lg" role="button">
                                    <i class="ri-share-line me-2 align-middle"></i>Share Now
                                </a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card custom-card featured-jobs">
                                        <div class="card-body">
                                            <div class="btn-list float-end">
                                                <a href="javascript:void(0);"
                                                    class="avatar avatar-sm avatar-rounded bg-light text-default"><v-tooltip
                                                        activator="parent" location="top">Add to
                                                        wishlist</v-tooltip><span><i class="bi bi-heart"></i></span></a>
                                                <a href="javascript:void(0);"
                                                    class="avatar avatar-sm avatar-rounded bg-warning-transparent"><v-tooltip
                                                        activator="parent" location="top">Featured
                                                        Jobs</v-tooltip><span><i class="bi bi-star-fill"></i></span></a>
                                            </div>
                                            <div class="d-flex mb-3 flex-wrap gap-2">
                                                <div>
                                                    <span
                                                        class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border"><svg
                                                ...
                                                <div class="ms-2">
                                                    <h5 class="fw-semibold mb-0 d-flex align-items-center"><a
                                                            href="javascript:void(0);"> HTML Developer</a></h5>
                                                    <a href="javascript:void(0);"><i class="bi bi-building"></i> Spotech
                                                        Technical Solutions</a>
                                                </div>
                                            </div>
                                            <div class="popular-tags mb-3">
                                                <a href="javascript:void(0);"
                                                    class="badge rounded-pill bg-light text-default me-2"><i
                                                        class="bi bi-geo-alt text-muted me-1"></i> Hyderabad</a>
                                                <a href="javascript:void(0);"
                                                    class="badge rounded-pill bg-light text-default me-2"><i
                                                        class="bi bi-mortarboard text-muted me-1"></i> Graduate</a>
                                                <a href="javascript:void(0);"
                                                    class="badge rounded-pill bg-light text-default"><i
                                    ...
                                    <div class="card custom-card featured-jobs">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-wrap gap-2 mb-3">
                                                ...
                                                <div class="ms-2">
                                                    <h5 class="fw-semibold mb-0 d-flex align-items-center"><a
                                                            href="javascript:void(0);"> React Developer</a></h5>
                                                    <a href="javascript:void(0);"><i class="bi bi-building"></i>
                                                        Infratech PVT LTD</a>
                                                </div>
                                            </div>
                                            <div class="popular-tags mb-3">
                                    ...
                                    <div class="card custom-card featured-jobs">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-wrap gap-2 mb-3">
                                                ...
                                                <div class="ms-2">
                                                    <h5 class="fw-semibold mb-0 d-flex align-items-center"><a
                                                            href="javascript:void(0);"> Vuejs Developer</a></h5>
                                    ...
                                    <div class="card custom-card featured-jobs">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-wrap gap-2 mb-3">
                                                ...
                                                <div class="ms-2">
                                                    <h5 class="fw-semibold mb-0 d-flex align-items-center"><a
                                                            href="javascript:void(0);"> Wordpress Developer</a></h5>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item mb-2">
                                <div class="d-sm-flex">
                                    ...
                                    <div class="ms-2 flex-grow-1">
                                        <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);"> React Lead
                                                Developer</a></p>
                            ...
                            <li class="list-group-item mb-2">
                                <div class="d-sm-flex">
                                    ...
                                    <div class="ms-2 flex-grow-1">
                                        <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);"> HTML Developer -
                                                Fresher</a></p>
                                        <p class="mb-0 me-3"><i class="bi bi-building text-muted"></i> Spruko Technologies
                                            PVT LTD</p>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item mb-2">
                                <div class="d-sm-flex">
                                    ...
                                    <div class="ms-2 flex-grow-1">
                                        <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);"> Wordpress Developer
                                                - Remote</a></p>
                                        <p class="mb-0 me-3"><i class="bi bi-building text-muted"></i> Hardware Private
                                            Solutions</p>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="d-sm-flex">
                                    ...
                                    <div class="ms-2 flex-grow-1">
                                        <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);"> Vuejs Frontend
                                                Developer</a></p>
                                        <p class="mb-0 me-3"><i class="bi bi-building text-muted"></i> G Technical Solutions
                                        </p>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item mb-2">
                                <div class="d-sm-flex">
                                    ...
                                    <div class="ms-2 flex-grow-1">
                                        <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);">Infratech PVT
                                                LTD</a></p>
                                        <p class="mb-0 me-3"><i class="bi bi-briefcase text-muted"></i> React Lead Developer
                                        </p>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item mb-2">
                                <div class="d-sm-flex">
                                    <span class="avatar avatar-md avatar-rounded bg-gray-200 border">
                                        <img src="/images/company-logos/6.png" alt="">
                                    </span>
                                    <div class="ms-2 flex-grow-1">
                                        <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);">Spruko Technologies
                                                PVT LTD</a></p>
                                        <p class="mb-0 me-3"><i class="bi bi-briefcase text-muted"></i> HTML Developer -
                                            Fresher</p>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item mb-2">
                                <div class="d-sm-flex">
                                    ...
                                    <div class="ms-2 flex-grow-1">
                                        <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);">Hardware Private
                                                Solutions </a></p>
                                        <p class="mb-0 me-3"><i class="bi bi-briefcase text-muted"></i> Wordpress Developer
                                        </p>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item mb-2">
                                <div class="d-sm-flex">
                                    ...
                                    <div class="ms-2 flex-grow-1">
                                        <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);"> G Technical
                                                Solutions</a></p>
                                        <p class="mb-0 me-3"><i class="bi bi-briefcase text-muted"></i> Vuejs Frontend
                                            Developer</p>
                                    </div>
                                </div>
                            </li>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="">
                            ...
                            <p>Latest jobs updates on the go to recieved direct to your email. Stay updated with your latest
                                new jobs.</p>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Email Here" aria-label="blog-email"
                                    aria-describedby="blog-subscribe">
                                <button class="btn btn-primary" type="button" id="blog-subscribe">Subscribe</button>
                            </div>
                            <label class="form-check-label">
                                By Subscribing you accept to <a href="javascript:void(0);" class="text-success"><u>privacy
                                        policy</u></a>
                            </label>
                        </div>
                    </div>
