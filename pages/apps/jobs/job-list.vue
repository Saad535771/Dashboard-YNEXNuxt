            ...
            <div class="card custom-card overflow-hidden">
                <div class="card-header justify-content-between">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <NuxtLink to="/apps/jobs/job-post" class="btn btn-primary btn-wave btn-sm">
                            ...
                            <tbody>
                                <tr>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-2">
                                                <p class="fw-semibold mb-0 d-flex align-items-center">
                                                    <NuxtLink to="/apps/jobs/job-details"> HTML Developer - Fresher
                                                    </NuxtLink>
                                                </p>
                                    ...
                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>Nov 12
                                            2022</span></td>
                                    <td>
                                        <NuxtLink to="/apps/jobs/job-details"
                                            class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                            <i class="ri-eye-line"></i>
                                        </NuxtLink>
                                        <a href="javascript:void(0);"
                                            class="ms-1 btn btn-icon btn-sm btn-info-light btn-wave waves-effect waves-light">
                                            <i class="ri-edit-line"></i>
                                        </a>
                                        <a href="javascript:void(0);"
                                            class="ms-1 btn btn-icon btn-sm btn-danger-light btn-wave waves-effect waves-light">
                                ...
                                <tr>
                                    <td class="ps-4"><input class="form-check-input" type="checkbox"
                                            id="checkboxNoLabeljob33" value="" aria-label="..." checked=""></td>
                                    <td>
                                        <div class="d-flex">
                                            <span class="avatar avatar-md avatar-rounded bg-primary bg-opacity-10"><svg
                                                    xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                                            ...
                                            <div class="ms-2">
                                                <p class="fw-semibold mb-0 d-flex align-items-center">
                                                    <NuxtLink to="/apps/jobs/job-details"> React Lead Developer</NuxtLink>
                                                </p>
                                                <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="avatar avatar-sm p-1 me-1 bg-light avatar-rounded">
                                                <img src="/images/company-logos/10.png" alt="">
                                            </span>
                                    ...
                                    <td><span class="badge bg-danger-transparent"><i class="bi bi-clock me-1"></i>Dec 07
                                            2022</span></td>
                                    <td>
                                        <NuxtLink to="/apps/jobs/job-details"
                                            class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                ...
                                <tr>
                                    <td class="ps-4"><input class="form-check-input" type="checkbox"
                                            id="checkboxNoLabeljob44" value="" aria-label="..." checked=""></td>
                                    <td>
                                        <div class="d-flex">
                                            <span class="avatar avatar-md avatar-rounded bg-primary bg-opacity-10"><svg
                                                    xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                                            ...
                                            <div class="ms-2">
                                                <p class="fw-semibold mb-0 d-flex align-items-center">
                                                    <NuxtLink to="/apps/jobs/job-details"> Vuejs Frontend Developer
                                                    </NuxtLink>
                                                </p>
                                                <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                            </div>
                                    ...
                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>Jan 15
                                            2022</span></td>
                                    <td>
                                        <NuxtLink to="/apps/jobs/job-details"
                                            class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                ...
                                <tr>
                                    <td class="ps-4"><input class="form-check-input" type="checkbox"
                                            id="checkboxNoLabeljob55" value="" aria-label="..."></td>
                                    <td>
                                        <div class="d-flex">
                                            <span class="avatar avatar-md avatar-rounded bg-primary bg-opacity-10"><svg
                                                    xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                                            ...
                                            <div class="ms-2">
                                                <p class="fw-semibold mb-0 d-flex align-items-center">
                                                    <NuxtLink to="/apps/jobs/job-details"> Wordpress Developer - Remote
                                                    </NuxtLink>
                                                </p>
                                                <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                            </div>
                                    ...
                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>Feb 12
                                            2022</span></td>
                                    <td>
                                        <NuxtLink to="/apps/jobs/job-details"
                                            class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
