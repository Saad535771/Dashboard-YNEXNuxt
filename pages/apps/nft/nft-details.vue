<script lang="ts">
import PageHeader from "@/components/common/pageheader.vue"; import { Swiper, SwiperSlide } from "swiper/vue";
                            ...
                            <div class="row">
                                <div class="col-xxl-12 col-sm-12 mb-md-5 mb-3">
                                    <swiper :style="{
                                        ...
                                        <swiper-slide><img class="img-fluid rounded"
                                                src="/images/nft-images/32.png" /></swiper-slide>
                                        <swiper-slide><img class="img-fluid rounded"
                                                src="/images/nft-images/31.png" /></swiper-slide>
                                        <swiper-slide><img class="img-fluid rounded"
                                                src="/images/nft-images/30.png" /></swiper-slide>
                                        <swiper-slide><img class="img-fluid rounded"
                                                src="/images/nft-images/33.png" /></swiper-slide>
                                    </swiper>
                                    <swiper @swiper="setThumbsSwiper" :spaceBetween="10" :slidesPerView="4" :freeMode="true"
                                        ...
                                        <swiper-slide><img class="img-fluid"
                                                src="/images/nft-images/32.png" /></swiper-slide>
                                        <swiper-slide><img class="img-fluid"
                                                src="/images/nft-images/31.png" /></swiper-slide>
                                        <swiper-slide><img class="img-fluid"
                                                        ...
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <div class="similar-products-image me-2">
                                                                    <img src="/images/nft-images/16.png" alt="">
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <p
                                                                        ...
                                                                        Neo-Nebulae</p>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">13.2k<i
                                                                                class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                    ...
                                                                    <p class="mb-0 fs-16 fw-semibold">
                                                                        <span
                                                                            class="avatar avatar-xs avatar-rounded p-1"><img
                                                                                src="/images/crypto-currencies/regular/Ethereum.svg"
                                                                                alt=""></span>1.099
                                                                    </p>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <div class="similar-products-image me-2">
                                                                    <img src="/images/nft-images/17.png" alt="">
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <p
                                                                        class="mb-1 fs-14 fw-semibold similar-product-name text-truncate">
                                                                        Chromatic Chaos</p>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">5.2k<i
                                                                                class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <div class="similar-products-image me-2">
                                                                    <img src="/images/nft-images/18.png" alt="">
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <p
                                                                        class="mb-1 fw-semibold similar-product-name text-truncate">
                                                                        Surreal Synthesis</p>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">2.4k<i
                                                                                class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <div class="similar-products-image me-2">
                                                                    <img src="/images/nft-images/19.png" alt="">
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <p
                                                                        class="mb-1 fw-semibold similar-product-name text-truncate">
                                                                        Virtual Visions</p>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">1.8k<i
                                                                                class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <div class="similar-products-image me-2">
                                                                    <img src="/images/nft-images/20.png" alt="">
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <p
                                                                        class="mb-1 fw-semibold similar-product-name text-truncate">
                                                                        Pixel Prism</p>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">12.9k<i
                                                                                class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <div class="similar-products-image me-2">
                                                                    <img src="/images/nft-images/21.png" alt="">
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <p
                                                                        class="mb-1 fw-semibold similar-product-name text-truncate">
                                                                        Electric Euphoria</p>
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">4.5k<i
                                                                                class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <div class="similar-products-image me-2">
                                                                    <img src="/images/nft-images/22.png" alt="">
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <p
                                                                        class="mb-1 fw-semibold similar-product-name text-truncate">
                            ...
                            <div class="row gx-5">
                                <div class="col-xl-12 mt-xxl-0 mt-3">
                                    <div>
                                        ...
                                        <p class="fs-18 mb-4">
                                            <i class="ri-heart-3-fill text-danger align-middle me-1"></i>
                                            <span class="fw-semibold text-muted"><a class="text-info fs-14"
                                                    href="javascript:void(0);">(2.4k Likes)</a></span>
                                        </p>
                                        <div class="row mb-4">
                                            <div class="col-xxl-3 col-xl-12">
                                                <p class="mb-1 lh-1 fs-11 text-success fw-semibold">Special Offer</p>
                                                <p class="mb-1"><span class="h3"><span
                                                            class="avatar avatar-sm avatar-rounded p-1 bg-light me-2"><img
                                                                src="/images/crypto-currencies/regular/Ethereum.svg"
                                                                alt=""></span>1.299<sup class="fs-14">.00</sup></span><span
                                            ...
                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                ...
                                                <div class="d-flex align-items-center fw-semibold">
                                                    <span class="avatar avatar-xs avatar-rounded lh-1 me-1"><img
                                                            src="/images/faces/9.jpg" alt=""></span>
                                                    Json Taylor
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <p class="text-muted mb-0">
                                                ...
                                                and ethereal world, where vibrant colors blend seamlessly with abstract
                                                forms. The artwork is a digital representation of the artist's imagination,
                                                combining elements of surrealism and futuristic aesthetics.
                                            </p>
                                        </div>
                                        <div class="mb-4">
                                            <div class="row justify-content-center">
                                                    ...
                                                    <div class="ecommerce-assurance">
                                                        <p class="mb-3">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                                                                <linearGradient id="a" x1="32" x2="32" y1="63.723" y2=".835"
                                                                ...
                                                                <linearGradient id="b" x1="35.769" x2="35.769" y1="63.723"
                                                                    y2=".835" gradientTransform="matrix(1 0 0 -1 0 63.89)"
                                                                    gradientUnits="userSpaceOnUse">
                                                                    <stop offset="0" stop-color="#2ab793" />
                                                                    <stop offset="1" stop-color="#2c98b5" />
                                                                </linearGradient>
                                                    ...
                                                    <div class="border p-3">
                                                        <div class="d-sm-flex d-block align-items-top mb-3">
                                                            <div class="d-flex flex-fill">
                                                                ...
                                                                <div class="lh-1 me-2">
                                                                    ...
                                                                    <div class="mb-1">
                                                                        <i
                                                                            class="ri-star-fill align-middle text-warning align-middle fs-12"></i>
                                                                        <i
                                                                            class="ri-star-fill align-middle text-warning align-middle fs-12"></i>
                                                                        <i
                                                                            class="ri-star-fill align-middle text-warning align-middle fs-12"></i>
                                                        ...
                                                        <div class="ps-sm-4 ps-0 mb-3">
                                                            ...
                                                            <p class="mb-0 fs-12 text-muted ps-2">Digital Dreamspace is a
                                                                truly captivating NFT that takes you on an unforgettable
                                                                journey. The artwork's vivid colors and ethereal elements
                                                                create a sense of tranquility and wonder </p>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    <div class="products-review-images">
                                                                        <a href="javascript:void(0);">
                                                                            <img src="/images/nft-images/13.png" alt="">
                                                                        </a>
                                                                        <a href="javascript:void(0);">
                                                                            <img src="/images/nft-images/15.png" alt="">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div
