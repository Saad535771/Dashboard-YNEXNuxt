            ...
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-xxl-6 col-xl-7 col-lg-7 col-md-7 col-sm-8 col-12">
                    <div class="p-5">
                        ...
                        <div class="btn-list">
                            <button class="btn btn-lg btn-light"><svg class="google-svg" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="row gy-3">
                            <div class="col-xl-12 mt-0">
                                ...
                                <div class="input-group">
                                    <passwordInput initialValue="" name="currentpassword" id="currentpassword"
                            ...
                            <div class="col-xl-12 mb-3">
                                ...
                                <div class="input-group">
                                    <passwordInput initialValue="" name="confirmpassword" id="confirmpassword"
                            ...
                            <div class="col-xl-12 d-grid mt-2">
                                <NuxtLink to="/authentication/sign-in/cover" class="btn btn-lg btn-primary">Create
                                </NuxtLink>
                            </div>
                        </div>
                        <div class="text-center">
                            <p class="fs-12 text-muted mt-4">Already have an account? <NuxtLink
                                    to="/authentication/sign-in/cover" class="text-primary">Sign In</NuxtLink>
                            </p>
                        </div>
                    </div>
                </div>
