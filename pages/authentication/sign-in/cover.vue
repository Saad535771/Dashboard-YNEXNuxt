                    ...
                    <div class="p-5">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-xl-12 d-grid mt-2">
                                <NuxtLink to='/' class="btn btn-lg btn-primary">Sign In</NuxtLink>
                            </div>
                        </div>
                        <div class="text-center">
                            <p class="fs-12 text-muted mt-4">Dont have an account? <NuxtLink
                                    to="/authentication/sign-up/cover" class="text-primary">Sign Up</NuxtLink>
                            </p>
                        </div>
                    </div>
                </div>
