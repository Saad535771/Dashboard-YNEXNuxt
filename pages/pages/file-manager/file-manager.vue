                    ...
                    <ul class="list-unstyled files-main-nav" id="files-main-nav">
                        ...
                        <li class="mb-4">
                            ...
                            <div class="progress progress-xs">
                                <div class="progress-bar bg-info" role="progressbar" style="width: 58%" aria-valuenow="58"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-sm btn-icon btn-light" data-bs-dismiss="modal"><i
                        ...
                        <div class="card border custom-card shadow-none">
                            <div class="card-body bg-primary-transparent">
                                <div
                                    ...
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="svg-primary" data-name="Layer 1"
                                            viewBox="0 0 24 24">
                                            <path opacity="1"
                                    ...
                                    <div>
                                        <div class="dropdown">
                                            <button class="btn btn-sm btn-icon btn-primary btn-wave waves-light"
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item" href="javascript:void(0);">Hide Folder</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="card border custom-card shadow-none">
                            <div class="card-body">
                                <div
                                    ...
                                    <div>
                                        <div class="dropdown">
                                            <button class="btn btn-sm btn-icon btn-primary-light btn-wave waves-light"
                                                type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                <i class="ri-more-2-fill"></i>
                                            </button>
                                            <ul class="dropdown-menu">
                        ...
                        <div class="table-responsive border border-bottom-0">
                            <table class="table text-nowrap table-hover">
                                ...
                                <tbody class="files-list">
                                    <tr>
                                        <th scope="row">
                                            <div @click="showDetails" class="d-flex align-items-center">
                                                <div class="me-2">
                                        ...
                                        <td>
                                            <div class="hstack gap-2 fs-15">
                                                <a href="javascript:void(0);"
                                                    @click="showDetails" class="btn btn-icon btn-sm btn-info-transparent rounded-pill"><i
            ...
            <div class="d-flex p-3 align-items-center justify-content-between border-bottom">
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown me-1">
                        <button class="btn btn-sm btn-icon btn-primary-light btn-wave waves-light waves-effect waves-light"
                            type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="ri-more-2-fill"></i>
                        </button>
                        <ul class="dropdown-menu">
            ...
            <PerfectScrollbar>
                <div class="filemanager-file-details" id="filemanager-file-details">
                    ...
                    <div class="p-3 border-bottom border-block-end-dashed">
                        ...
                        <a class="text-primary fw-semibold text-break" href="javascript:;"
                            target="_blank">
